...
ROOM_PATTERN_PRESETS = {
    ...
    "numeric_floor_room": {
        "label": "Numerisch - Geschoss.Raum",
        "description": (
            "Für rein numerische Raumnummern wie "
            "-01.503, 00.302, 01.514 oder 2.4. "
            "Typische Mass-, Flächen-, Höhen- und Kotenwerte "
            "werden bei der Extraktion gezielt ausgefiltert."
        ),
        "pattern": NUMERIC_FLOOR_ROOM_PATTERN,
    },
    "letters_numbers": {
...
# Standard-Suchradius für normale alphanumerische Raumnummern.
ROOM_SEARCH_RADIUS = 4

# Numerische Raumnummern können in exportierten PDFs etwas weiter vom
# Luftmengenblock entfernt liegen. Die zusätzlichen Plausibilitätsfilter
# verhindern dabei, dass typische Dezimal-Messwerte als Räume verwendet werden.
NUMERIC_ROOM_SEARCH_RADIUS = 8
