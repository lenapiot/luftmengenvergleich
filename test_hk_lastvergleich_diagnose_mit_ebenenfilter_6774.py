...
def main() -> None:
    ...
    # --------------------------------------------------------
    # 7. VERGLEICHSUMFANG SICHTBAR AUSGEBEN
    # --------------------------------------------------------
    ...
    note = scope.get(
        ...
        (
            ...
            "für die Grundrisse ausgewählt wurden."
        ),
    )

    print()
    print("=" * 80)
    print("VERGLEICHSUMFANG")
    print("=" * 80)
    ...
    print()
    print(
        "Diese nicht geprüften Ebenen "
        "werden NICHT als Fehler oder "
        "'Nur im Schema' gewertet."
    )

    # --------------------------------------------------------
    # 8. ALLGEMEINE DIAGNOSE
    # --------------------------------------------------------
    ...
    if considered_levels:
        ...
        print(
            "Schema-Räume im Vergleichsumfang:",
            schema_in_scope[
                "raumnummer"
            ].nunique()
            if not schema_in_scope.empty
            else 0,
        )
    ...
    # --------------------------------------------------------
    # 10. DIAGNOSE DER VERBLEIBENDEN FÄLLE
    # --------------------------------------------------------
    ...
    print_examples(
        ...
        (
            "IM GEPRÜFTEN SCHEMA-BEREICH, "
            "ABER NICHT IM HEIZLAST-GRUNDRISS"
        ),
    )
    ...
    print_examples(
        ...
        (
            "IM GEPRÜFTEN SCHEMA-BEREICH, "
            "ABER NICHT IM KÜHLLAST-GRUNDRISS"
        ),
    )
    ...
    print_examples(
        ...
        (
            ...
            "ABER NICHT IM GEPRÜFTEN SCHEMA-BEREICH"
        ),
    )
